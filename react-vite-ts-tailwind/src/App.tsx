...
function App() {
    ...
    return (
        <div className="w-screen h-screen p-6 flex justify-center items-center dark:bg-black">
            <main
                className="relative py-16 px-20 mb-16 shadow-lg shadow-cyan-600/30 border-2 border-b-0 border-cyan-200/50 rounded-xl overflow-hidden">
                <div className="flex flex-col items-center gap-12">
                    <div className="flex justify-center items-center gap-4 ps-1">
                        <img
                            className="size-28 transition drop-shadow-xl hover:drop-shadow-[0_0_30px_rgba(56,189,248,0.30)]"
                    ...
                    <div className="text-center">
                        <button type="button"
                                ...
                                className="px-6 py-2 text-white font-medium text-sm rounded-lg shadow-lg shadow-cyan-500/50 bg-gradient-to-br from-cyan-500 to-blue-500 hover:bg-gradient-to-l">
                            count is {count}
                        </button>
                ...
                <div className="absolute pointer-events-none left-[7%] top-0 opacity-50">
                    <svg width="1237" height="405" viewBox="0 0 1237 405" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <g filter="url(#filter1)">
                            <ellipse cx="618.5" cy="-213" rx="268.5" ry="268" fill="#48DCFF"></ellipse>
                        </g>
                        <defs>
                            <filter id="filter1" x="0" y="-831" width="1237" height="1236"
                ...
                <div className="absolute pointer-events-none right-[7%] top-0 opacity-50">
                    <svg width="1237" height="405" viewBox="0 0 1237 405" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <filter id="filter2" x="0" y="-831" width="1237" height="1236"
                                    filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                                <feFlood floodOpacity="0"/>
                                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
                                <feGaussianBlur stdDeviation="175"/>
                ...
                <div className="absolute pointer-events-none bottom-0 left-1/2 -translate-x-1/2">
                    <svg width="702" height="2" viewBox="0 0 702 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <filter id="filter3" x="0" y="0" width="702" height="4"
                                    filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                                <feFlood floodOpacity="0"/>
                ...
                <div className="absolute pointer-events-none bottom-0 left-1/2 -translate-x-1/2">
                    <svg width="708" height="5" viewBox="0 0 708 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <filter id="filter4" x="0" y="0" width="708" height="10"
                                    filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                                <feFlood floodOpacity="0"/>
                                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix"/>
            ...
            <div className="absolute pointer-events-none top-0 w-full h-full opacity-20 transform rotate-180">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 1008" className="w-full h-full">
                    <g filter="url(#filter5)">
                        <path transform="rotate(5.378 -555.062 600)" fill="url(#gradient3)"
                              d="M-555.062 600h2166.28v1045h-2166.28z"/>
                    </g>
                    <defs>
                        <linearGradient id="gradient3" x1="446.248" y1="2186" x2="1151.32" y2="235.034"
                                        gradientUnits="userSpaceOnUse">
                            <stop stopColor="#4FC3F7"/>
                            <stop offset=".898" stopColor="#81D4FA" stopOpacity=".64"/>
                            <stop offset="1" stopColor="#fff"/>
                        </linearGradient>
                        <filter id="filter5" x="-1253" y="0" width="3454.68" height="2443.42"
